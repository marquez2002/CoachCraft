 ...
 * Descripción: Este archivo define el widget para la pantalla de registro de usuario.
 *              Los usuarios pueden crear una nueva cuenta proporcionando un correo electrónico y contraseña.
 *              Incluye validación del formulario y redirección a la pantalla de inicio de sesión o menú si el registro es exitoso.
 * 
 * Autor: Gonzalo Márquez de Torres
 * 
 * Notas adicionales:
 * - El widget permite registrar usuarios nuevos en el sistema comprobando que no se encuentra registrado
 */
