...
class MidBasketFieldScreen extends StatefulWidget {
  const MidBasketFieldScreen({super.key});
...
class _BasketFieldScreenState extends State<MidBasketFieldScreen> {
  List<Offset> points = [];
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            Center(
              child: Image.asset(
                'assets/image/mid_basket_field.png',
                fit: BoxFit.contain,
              ),
            ),
            GestureDetector(
